...
<div class="card card-default">
  <div class="card-header card-header-border-bottom">
    <a href="{{ route('testimonial.index')}}">All Review</a>
  </div>
  <div class="card-body">
       <form action="{{route('testimonial.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="tagline" value="{{ old('tagline') }}"  class="form-control" id="tagline" >
        </div>    
        @if ($errors->has('slug'))
      ...
      <hr>
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="summernote"  name="review" id="exampleFormControlTextarea1" rows="10">{{ old('review') }}</textarea>
        </div>
