  ...
  <div class="card-body">
   <form action="{{route('portfolio.store')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="para" value="{{ old('para') }}"  class="form-control" id="para" >
    </div>   
    ...
    <div class="mb-3">
      ...
      <input type="text" name="buttonText" value="{{ old('buttonText') }}"  class="form-control" id="buttonText" >
    </div>   
