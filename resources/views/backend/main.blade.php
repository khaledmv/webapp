...
<html lang="en" dir="ltr">
  ...
  <title> @yield('title', 'WebAiid eCom Solution') </title>
...
<div class="page-wrapper">
              ...
              <li class="dropdown user-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                  ...
                  <li class="dropdown-footer">
                      ...
                      {{-- <a href="{{ auth('web')->logout()}}"> <i class="mdi mdi-logout"></i> Log Out </a> --}}
  ...
  <script src="{{ asset('backend/assets/plugins/jasny/jasny.min.js')}}"></script>
